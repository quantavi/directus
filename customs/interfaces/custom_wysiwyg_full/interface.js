...
define([
  ...
  'tinyMCE',
  'core/notification'
], function (app, Utils, _, UIView, tinyMCE, Notification) {
  'use strict';

  return UIView.extend({
    template: 'custom_wysiwyg_full/input',
      ...
      var options = {
        ...
        images_upload_handler: function (blobInfo, success, failure) {
        	...
        	var settings = {
				"async": true,
				"crossDomain": true,
				"url": "http://localhost:8888/directus/api/1.1/files",
				"method": "POST",
				"data": data
			};
			$.ajax(settings)
				...
				.fail(function (response) {
					...
					Notification.warn("tinyMCE Image Upload Handler", response);
				});
        },
